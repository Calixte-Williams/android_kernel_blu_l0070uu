...
//yaohua.li start 
        ...
        printk("===lgc===value_RF_ID1= %d  \n",value_RF_ID1);
        printk("===lgc===value_RF_ID2= %d  \n",value_RF_ID2);
        if(value_RF_ID1==0&&value_RF_ID2==0)
        {
            scaned_num = scan_image_list(md->index, "modem_%d_%s_1.img", tmp_md_img_list, MAX_IMG_NUM);
            printk("===lgc===value_RF_ID==1=l5460_lwg_modem_wiko_multimd_01==wik_eu vn du=====\n");
        }
        else if(value_RF_ID1==0 && value_RF_ID2==1)
        {
            scaned_num = scan_image_list(md->index, "modem_%d_%s_2.img", tmp_md_img_list, MAX_IMG_NUM);
            printk("===lgc===value_RF_ID2==2=l5460_lwg_modem_wiko_multimd_02=wik_th======\n");
        }
        else if(value_RF_ID1==1 && value_RF_ID2==0)
        {
            scaned_num = scan_image_list(md->index, "modem_%d_%s_3.img", tmp_md_img_list, MAX_IMG_NUM);
